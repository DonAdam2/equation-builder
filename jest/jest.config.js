...
module.exports = {
  ...
  transformIgnorePatterns: [
    '[/\\\\]node_modules[/\\\\](?!.*(react-error-boundary|uuid|katex)).+\\.(js|jsx|mjs|cjs|ts|tsx)$',
    '^.+\\.(css|sass|scss)$',
  ],
  modulePaths: [],
  ...
  moduleNameMapper: {
    ...
    '^@/contexts(.*)$': `<rootDir>/../${rootDirectory}/contexts/$1`,
    '^@/data(.*)$': `<rootDir>/../${rootDirectory}/data/$1`,
    '^@/models(.*)$': `<rootDir>/../${rootDirectory}/models/$1`,
    '^@/utils(.*)$': `<rootDir>/../${rootDirectory}/utils/$1`,
